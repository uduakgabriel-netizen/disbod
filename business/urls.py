...
urlpatterns = [
    ...
    path('posts/', views_posts.BusinessPostListCreateView.as_view(), name='business-posts'),
    path('posts/<int:pk>/', views_posts.BusinessPostDetailView.as_view(), name='business-post-detail'),
]
